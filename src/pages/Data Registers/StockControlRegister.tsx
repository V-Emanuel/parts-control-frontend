...
export default function StockControlRegister() {
  ...
  function postOrder() {
    ...
    axios
      .post(`${api_url}/stockcontrol`, body, {
        headers: {
      ...
      .then(() => {
        setShowModal(false);
        alert('Controle de Estoque adicionado com Sucesso!');
        window.location.reload();
      })
      .catch((err) => {
        console.error(err);
        setShowModal(false);
        alert('Erro ao Adicionar Controle de Estoque');
      })
      .finally(() => {
  ...
  return (
    <OrderRegisterStyles>
      ...
      <div className="form-content">
        <h1>Adicionar Controle de Entrada Estoque</h1>
